...
const SignIn = () => {
    ...
    const response = await fetch(apiUrl, {
      ...
      .then((data) => {
        ...
        if (token) {
          ...
          setShowEmailForm(false);
          alert("You are logged in!"); // Show an alert
          navigate("/browse");
        } else {
  ...
  return (
    ...
    C9.6,4.2,10.7,3.6,11.3,2.9"
              ...
              <h1 style={{ marginBottom: "20px", marginLeft: "29px" }}>Sign In or Sign Up</h1>
          ...
          >
            ...
            <p style={{ fontSize: "11px" }}>
              ...
              exclusive content, special offers, and marketing and
              recommendations for apps, music, movies, TV, books, podcasts,
              Apple Pay, and more.
            </p>

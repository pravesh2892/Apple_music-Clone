    ...
    >
      ...
      {showEmailForm ? (
        <>
          ...
          <Link
            to="/change-password"
            style={{ marginBottom: "20px", color: "#fa233b" }}
          >
            Forgot Apple ID or Password?
          </Link>
          <span
            aria-describedby="gdpr-panes-icon"
            class="gdpr-panes__icon"
          ></span>
          <p
            className="gdpr-panes__text gdpr-panes__text--account typography-caption"
            data-test="gdpr-pane-account"
            role="link"
            tabindex="0"
          >
            Your Apple ID information is used to allow you to sign in securely
            and access your data. Apple records certain data for security,
            support, and reporting purposes. If you agree, Apple may also use
            your Apple ID information to send you marketing emails and
            communications, including based on your use of Apple services.{" "}
          </p>
          <button
